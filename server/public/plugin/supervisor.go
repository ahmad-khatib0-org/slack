...
func WithExecutableFromManifest(pluginInfo *model.BundleInfo) func(*supervisor, *plugin.ClientConfig) error {
	return func(_ *supervisor, clientConfig *plugin.ClientConfig) error {
		...
		// This doesn't add more security than before but removes the SecureConfig is nil warning.
...
func newSupervisor(
	...
	apiImpl API,
	driver AppDriver,
	parentLogger *mlog.Logger,
	metrics metricsInterface,
	opts ...func(*supervisor, *plugin.ClientConfig) error,
) (retSupervisor *supervisor, retErr error) {
	sup := supervisor{

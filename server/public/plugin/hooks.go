...
//
// Feel free to add more, but do not change existing assignments. Follow the naming
// convention of <HookName>ID as the autogenerated glue code depends on that.
const (
	OnActivateID                              = 0
	OnDeactivateID                            = 1
	ServeHTTPID                               = 2
...
const (
	// DismissPostError dismisses a pending post when the error is returned
	// from MessageWillBePosted.

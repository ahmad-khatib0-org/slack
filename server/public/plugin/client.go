...
// WithTestReattachConfigCh configures the channel to receive the ReattachConfig
// used to reattach an externally launched plugin instance with the Mattermost server.
...
//
// Call this when your plugin is ready to start. Options allow configuring plugins

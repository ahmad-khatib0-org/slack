...
type PostMetadata struct {
	// Embeds holds information required to render content embedded in the post.
	// This includes the OpenGraph metadata for links in the post.
	...
	// Images holds the dimensions of all external images in the post as a map of the image
	// URL to its dimensions. This includes image embeds (when the message contains a plaintext
	// link to an image), Markdown images, images contained in the OpenGraph metadata, and
	// images contained in message attachments. It does not contain the dimensions of any
	// file attachments as those are stored in FileInfos.
...
type PostImage struct {
	...
	// FrameCount stores the number of frames in this image, if it is an animated gif.
	// It will be 0 for other formats.

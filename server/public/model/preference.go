...
const (
	...
	// PreferenceCategoryDirectChannelShow and PreferenceCategoryGroupChannelShow are
	// used to store the user's preferences for which channels to show in the sidebar.

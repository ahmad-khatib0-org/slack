...
// This includes dimensions of linked images and OpenGraph metadata.
type LinkMetadata struct {
	// Hash is a value computed from the URL and Timestamp for use as a
...
// truncateText ensure string is 300 chars, truncate and add ellipsis if it was bigger.
...
// shortening strings, trimming fields and reducing the number of images.
...
// DeserializeDataToConcreteType converts o.Data from JSON into properly structured data.
// This is intended to be used after getting a LinkMetadata object that has been stored
// in the database.

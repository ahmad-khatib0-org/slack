...
import (
	...
	"github.com/ahmad-khatib0-org/slack/server/public/shared/timezones"
...
// Make sure you actually want to use this function. In context.go there are
// functions to check permissions This function should not be used to check permissions.
...
// Make sure you actually want to use this function. In context.go there are functions
// to check permissions. This function should not be used to check permissions.
...
var (
	...
	validUsernameCharsForRemote = regexp.MustCompile(`^[a-z0-9\.\-_:]*$`)
)

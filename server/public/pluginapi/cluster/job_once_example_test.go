...
func ExampleJobOnceScheduler_ScheduleOnce() {
	...
	// Maybe you want to check the scheduled jobs, or cancel them. This is completely
	// optional--there is no need to cancel jobs, even if you are shutting down. Call
	// Cancel only when you want to cancel a future job. Cancelling a job will prevent
	// it from running in the future on this or any server.

...
import (
	...
	"github.com/ahmad-khatib0-org/slack/server/public/pluginapi/experimental/telemetry"
)
...
/*
New promotes the provided logger into a telemetry logger, storing all events below
the logLevel through the tracker.

...
import (
	...
	"github.com/ahmad-khatib0-org/slack/server/public/pluginapi/experimental/bot/logger"
	"github.com/ahmad-khatib0-org/slack/server/public/pluginapi/experimental/bot/poster"
	"github.com/ahmad-khatib0-org/slack/server/public/pluginapi/experimental/common"
)
...
/*
New promotes the provided logger into a admin cc logger, sending direct messages to all
the admin ids provided through the dmer provided, about all events below the logLevel.
If logVerbose is set, it will also send the context.

...
// IsLevelEnabled returns true only if at least one log target is configured to emit
// the specified log level. Use this check when gathering the log info may be expensive.
//

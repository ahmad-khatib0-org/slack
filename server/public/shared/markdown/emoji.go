...
var emojiRegex = regexp.MustCompile(`^:([a-z0-9_\-+]+):\B`)

// parseEmoji attempts to parse a named emoji (eg. :taco:) starting at the current
// parser position. If an emoji is found, it adds that to p.inlines and returns true.

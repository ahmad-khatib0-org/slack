...
// RenderHTML produces HTML with the same behavior as the example renderer used in
// the CommonMark reference materials except for one slight difference: for brevity,
// no unnecessary whitespace is inserted between elements. The output is not defined
// by the CommonMark spec, and it exists primarily as an aid in testing.

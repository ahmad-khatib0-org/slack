...
// Inspect traverses the markdown tree in depth-first order. If f returns true,
// Inspect invokes f recursively for each child of the block or inline, followed
// by a call of f(nil).
...
// InspectBlock traverses the blocks in depth-first order, starting with block. If
// f returns true, InspectBlock invokes f recursively for each child of the block,
...
// InspectInline traverses the blocks in depth-first order, starting with block. If
// f returns true, InspectInline invokes f recursively for each child of the block,
// followed by a call of f(nil).

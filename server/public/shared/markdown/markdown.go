// This package implements a parser for the subset of the CommonMark spec necessary
// for us to do server-side processing. It is not a full implementation and lacks many
// features. But it is complete enough to efficiently and accurately allow us to do
// what we need to like rewrite image URLs for proxying.
package markdown

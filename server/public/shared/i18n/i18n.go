...
// TranslationFuncByLocal is the type of function that takes local as a
// string and returns the translation function
...
// It must be kept in sync with webapp/channels/src/i18n/i18n.jsx.
...
// GetTranslationFuncForDir loads translations from the filesystem into a new
// instance of the bundle. It returns a function to access loaded translations.
...
// GetTranslationsAndLocaleFromRequest return the translation
// function and the locale based on a request headers

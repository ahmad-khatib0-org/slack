...
// MattermostTransport is an implementation of http.RoundTripper that ensures
// each request contains a custom user agent string to indicate that the request
// is coming from a Mattermost instance.

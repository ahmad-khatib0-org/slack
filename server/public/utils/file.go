...
// CopyFile will copy a file from src path to dst path. Overwrites any existing
// files at dst. Permissions are copied from file at src to the new file at dst.
